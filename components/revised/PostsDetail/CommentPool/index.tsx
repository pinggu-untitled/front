...
import CommentCardList from '@components/revised/PostsDetail/CommentPool/CommentCardList';
import CommentSendBox from '@components/revised/PostsDetail/CommentPool/CommentSendBox';
